...
export class LaeventComponent implements OnInit {
  ...
  constructor(fb: FormBuilder,private _http: HttpClient,private router: Router, private _commonservices : Commonservices,private route:ActivatedRoute, userdata: CookieService,private modalService: BsModalService,private sanitizer:DomSanitizer){
    this.chkerror = 0;
