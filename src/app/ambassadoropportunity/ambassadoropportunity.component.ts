...
@Component({
  selector: 'app-ambassadoropportunity',
  templateUrl: './ambassadoropportunity.component.html',
  styleUrls: ['./ambassadoropportunity.component.css'],
  providers: [Commonservices]
})
export class AmbassadoropportunityComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  constructor(fb: FormBuilder,private _http: HttpClient,private router: Router, private _commonservices : Commonservices,private route:ActivatedRoute, userdata: CookieService,private modalService: BsModalService) {
  ...
  ngOnInit() {
    this.dataForm = this.fb.group({
      ...
      email: ["", AmbassadoropportunityComponent.validateEmail],
      username: ["", AmbassadoropportunityComponent.validateUsername],
