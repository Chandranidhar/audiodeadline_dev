...
@Component({
  selector: 'app-contactus-old',
  templateUrl: './contactus-old.component.html',
  styleUrls: ['./contactus-old.component.css']
})
export class ContactusOldComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataForm = this.fb.group({
      ...
      email: ["", ContactusOldComponent.validateEmail],
