...
@Component({
  selector: 'app-media-interest-report',
  templateUrl: './media-interest-report.component.html',
  styleUrls: ['./media-interest-report.component.css'],
  providers: [Commonservices]
})
export class MediaInterestReportComponent implements OnInit {
