    ...
    constructor(private http: HttpClient,userdata: CookieService,private router: Router) {
        ...
        if(this.envflag=='live'){
           ...
           // this.siteurl = 'http://api.audiodeadline.com/';
            //this.nodeurl = 'http://192.169.196.208:3009/';
            // this.nodeurl = 'http://192.169.196.208:3007/';
        this.nodeurl = 'https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
        this.nodeurl1 = 'https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
        this.nodeurl2 = 'https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
        this.nodesslurl ='https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
        this.nodesslurl1 ='https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
        ...
        this.phpurlforshare = 'https://share.artistxp.com/';
            //this.url = 'https://audiodeadline.com/serverlocal.php?q=';
            this.url = 'https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
            this.url1 = 'https://w9v0ymx711.execute-api.us-east-2.amazonaws.com/dev/api/';
            // this.url = 'https://audiodeadline.com/server.php?q=';
            ...
            // this.uploadncropurlnew = 'https://audiodeadline.com/fileuploadandcropnew.php';
            this.fileurl = 'https://development-audiodeadline-serverless.s3.us-east-2.amazonaws.com/uploads/';
