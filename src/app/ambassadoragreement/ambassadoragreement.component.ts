...
export class AmbassadoragreementComponent implements OnInit {
    ...
    constructor(private _commonservices : Commonservices,private _http: HttpClient,private router: Router,private route:ActivatedRoute,private modalService: BsModalService, userdata: CookieService) {
