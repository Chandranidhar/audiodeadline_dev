...
export class SignupComponent implements OnInit {
    ...
    constructor(fb: FormBuilder,private _http: HttpClient,private router: Router, private _commonservices : Commonservices,private route:ActivatedRoute, userdata: CookieService){
        this.chkerror = 0;
